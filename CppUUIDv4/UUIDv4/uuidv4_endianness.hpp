...
#include <CppSimde/simde_x86_avx2.hpp>
  ...
  inline simde__m128i swap_u128(simde__m128i value) {
    const simde__m128i shuffle = simde_mm_set_epi64x(0x0001020304050607, 0x08090a0b0c0d0e0f);
    return simde_mm_shuffle_epi8(value, shuffle);
  }

  inline simde__m256i swap_u256(simde__m256i value) {
    const simde__m256i shuffle = simde_mm256_set_epi64x(0x0001020304050607, 0x08090a0b0c0d0e0f, 0x0001020304050607, 0x08090a0b0c0d0e0f);
    return simde_mm256_shuffle_epi8(value, shuffle);
  }
#endif // BIGENDIAN
